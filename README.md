...
* requests
* selenium + phantomjs
* selenium + firefox (Install by yourself)
* BeautifulSoup4
* lxml
...
First in accordance with the above steps to create a normal operation of the container example with the name of `spiderenv` .
...
When prompted the message of `All Installed OK` , It's OK.
